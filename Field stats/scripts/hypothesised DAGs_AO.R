...
adjustmentSets(m1, "Treatment", "Shoot_density", type="minimal")
adjustmentSets(m1, "Treatment", "Avg_LSA", type="minimal")
adjustmentSets(m1, "Week", "Shoot_density", type="minimal")
adjustmentSets(m1, "Week", "Avg_LSA", type="minimal")
adjustmentSets(m1, "Avg_LSA", "Crustacean_abundance", type="minimal")
adjustmentSets(m1, "Shoot_density", "Crustacean_abundance", type="minimal")
...
#identify adjustment sets
adjustmentSets(m2, "Treatment", "Shoot_density", type="minimal")
adjustmentSets(m2, "Treatment", "Avg_LSA", type="minimal")
adjustmentSets(m2, "Week", "Shoot_density", type="minimal")
adjustmentSets(m2, "Week", "Avg_LSA", type="minimal")
adjustmentSets(m2, "Week", "Crustacean_abundance", type="minimal")
adjustmentSets(m2, "Avg_LSA", "Crustacean_abundance", type="minimal")
adjustmentSets(m2, "Shoot_density", "Crustacean_abundance", type="minimal")
